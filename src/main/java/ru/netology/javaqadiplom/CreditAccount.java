...
public class CreditAccount extends Account {
    ...
    public CreditAccount(int initialBalance, int creditLimit, int rate) {
        ...
        if (creditLimit < 0) {
            throw new IllegalArgumentException("Кредитный лимит не должен быть отрицательным, а у вас:" + creditLimit);
        }
        if (initialBalance < 0) {
            throw new IllegalArgumentException("Начальный баланс не должен быть отрицательным, а у вас:" + initialBalance);
        }
        if (initialBalance > creditLimit) {
            throw new IllegalArgumentException("Начальный баланс не должен превышать кредитный лимит, а у вас:" + initialBalance);
        }

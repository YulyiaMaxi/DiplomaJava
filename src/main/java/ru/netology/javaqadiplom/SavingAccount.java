...
public class SavingAccount extends Account {
    ...
    public SavingAccount(int initialBalance, int minBalance, int maxBalance, int rate) throws IllegalArgumentException {
        ...
        if (minBalance < 0) {
            throw new IllegalArgumentException("Минимльный баланс не может быть отрицательным, а у Вас:" + minBalance);
        }
        if (balance < minBalance) {
            throw new IllegalArgumentException("Текущий баланс не может быть меньше минимального");
        }
        if (balance > maxBalance) {
            throw new IllegalArgumentException("Текущий баланс не может быть больше максимального");
        }
